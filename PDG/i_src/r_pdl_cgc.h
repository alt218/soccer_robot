...
#define PDL_CGC_CLK_IWDTLOCO			0x10u

/* Low-speed on-chip oscillator control */
#define PDL_CGC_LOCO_ENABLE				0x00000001ul
#define PDL_CGC_LOCO_DISABLE			0x00000002ul

/* High-speed on-chip oscillator control */
#define PDL_CGC_HOCO_ENABLE				0x00000004ul
#define PDL_CGC_HOCO_DISABLE			0x00000008ul

/* High-speed on-chip oscillator frequency control */
#define PDL_CGC_HOCO_32000				0x00000010ul
#define PDL_CGC_HOCO_36864				0x00000020ul
#define PDL_CGC_HOCO_40000				0x00000040ul
#define PDL_CGC_HOCO_50000				0x00000080ul
...
#define PDL_CGC_MAIN_RESONATOR			0x00001000ul
#define PDL_CGC_MAIN_EXTERNAL			0x00002000ul

/* Main clock oscillator drive type 1 */
#define PDL_CGC_MAIN_CERAMIC_SMT_16_20	0x00004000ul
#define PDL_CGC_MAIN_CERAMIC_LEAD_16_20	0x00008000ul

/* Main clock oscillator drive type 2 */
#define PDL_CGC_MAIN_1_8				0x00010000ul
#define PDL_CGC_MAIN_8_16				0x00020000ul
#define PDL_CGC_MAIN_16_20				0x00040000ul

/* Oscillation Stop Detection control */
#define PDL_CGC_OSC_STOP_ENABLE			0x00080000ul
#define PDL_CGC_OSC_STOP_INTERRUPT		0x00100000ul
#define PDL_CGC_OSC_STOP_DISABLE		0x00200000ul
#define PDL_CGC_OSC_STOP_CLEAR_FLAG		0x00400000ul

/* Sub-clock oscillator drive ability */
#define PDL_CGC_SUB_CLOCK_CL_LOW		0x00800000ul
#define PDL_CGC_SUB_CLOCK_CL_STANDARD	0x01000000ul
...
#define PDL_CGC_IWDTLOCO_ENABLE		0x04u
#define PDL_CGC_IWDTLOCO_DISABLE	0x08u

/* RTC initialization control  */
#define PDL_CGC_RTC_TO_BE_USED		0x10u
#define PDL_CGC_RTC_NOT_USE			0x20u
