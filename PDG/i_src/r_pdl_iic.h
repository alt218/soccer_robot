...
/* Pin selection */
#define PDL_IIC_PIN_SDA_P13				0x01u
#define PDL_IIC_PIN_SDA_P17				0x02u
#define PDL_IIC_PIN_SCL_P12				0x04u
#define PDL_IIC_PIN_SCL_P16				0x08u
