...
bool R_PG_Timer_Set_MTU_U0_C4(void)
{
	...
	parameters.TGR_C_D_operation = PDL_MTU2_C_OC_LOW_CM_HIGH | PDL_MTU2_D_OC_LOW_CM_INV;
	parameters.TGRA_TCNTV_value = 65535;
	parameters.TGRB_TCNTW_value = 32767;
	parameters.TGRC_TGRU_value = 65535;
	parameters.TGRD_TGRV_value = 32767;

	res = R_MTU2_Set(
		4,
		PDL_MTU2_PIN_4A_PB3 | PDL_MTU2_PIN_4C_PB1
	);
