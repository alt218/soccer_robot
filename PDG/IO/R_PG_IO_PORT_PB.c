...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Set_PB5(void)
*
* Function Name: R_PG_IO_PORT_Set_PB5
*
* Description  : I/Oポート(1端子)の設定
*
* Arguments    : なし
...
* Details      : 詳細についてはリファレンスマニュアルを参照してください。
******************************************************************************/
bool R_PG_IO_PORT_Set_PB5(void)
{
	return R_IO_PORT_Set(
		PDL_IO_PORT_B_5,
		PDL_IO_PORT_OUTPUT | PDL_IO_PORT_TYPE_CMOS | PDL_IO_PORT_DRIVE_NORMAL
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Write_PB5(uint8_t data)
*
* Function Name: R_PG_IO_PORT_Write_PB5
*
* Description  : I/Oポートデータレジスタへのビット書き込み
*
* Arguments    : uint8_t data : 書き込む値
...
* Details      : 詳細についてはリファレンスマニュアルを参照してください。
******************************************************************************/
bool R_PG_IO_PORT_Write_PB5(uint8_t data)
{
	return R_IO_PORT_Write(
		PDL_IO_PORT_B_5,
		data
